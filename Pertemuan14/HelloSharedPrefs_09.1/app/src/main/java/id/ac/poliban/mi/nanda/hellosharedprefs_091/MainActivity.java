package id.ac.poliban.mi.nanda.hellosharedprefs_091;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String sharedPrefFile = "id.ac.poliban.mi.nanda.hellosharedprefs_091";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("HelloSharedPrefs_Rayyan");
