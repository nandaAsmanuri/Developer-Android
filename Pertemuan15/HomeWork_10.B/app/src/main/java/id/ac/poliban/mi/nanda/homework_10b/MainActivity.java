package id.ac.poliban.mi.nanda.homework_10b;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String sharedPrefFile = "id.ac.poliban.mi.nanda.homework_10b";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Data Storage Types_Rayyan");
