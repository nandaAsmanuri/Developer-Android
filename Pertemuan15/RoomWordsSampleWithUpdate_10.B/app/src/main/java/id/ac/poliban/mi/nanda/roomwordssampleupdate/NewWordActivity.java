package id.ac.poliban.mi.nanda.roomwordssampleupdate;


import static id.ac.poliban.mi.nanda.roomwordssampleupdate.MainActivity.EXTRA_DATA_ID;
import static id.ac.poliban.mi.nanda.roomwordssampleupdate.MainActivity.EXTRA_DATA_UPDATE_WORD;
...
public class NewWordActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_REPLY = "id.ac.poliban.mi.nanda.roomwordssampleupdate.REPLY";
    public static final String EXTRA_REPLY_ID = "id.ac.poliban.mi.nanda.roomwordssampleupdate.REPLY_ID";
